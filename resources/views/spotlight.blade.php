...
@section('content')
            ...
            <div class="toolbar" id="kt_toolbar">
                <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                    <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                        ...
                        <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Spotlight</h1>
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                            ...
                            <li class="breadcrumb-item text-dark">Spotlight</li>
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                    <div class="d-flex align-items-center py-1">
                        <a href="#" class="btn btn-shadow btn-primary" data-bs-toggle="modal"
                            data-bs-target="#kt_modal_offer_a_deal">Add Spotlight</a>
                    </div>
                </div>
            </div>
                                        ...
                                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0" id="example">
                                            <thead>
                                                <tr class="fs-7 fw-bolder text-gray-500">
                                                    ...
                                                    <th class="min-w-150px">Spotlight</th>
                                                ...
                                                @if (!empty($plansList))
                                                    @foreach ($plansList as $key => $plans)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span
                                                                    class="text-muted">{{ $plans->spot_light_count }}</span>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td class="text-end">
                                                                <div class="d-flex justify-content-end flex-shrink-0">
                                                                    ...
                                                                    <a href="#"
                                                                        ...
                                                                        onclick="ShowSpotEditForm({{ $plans->id }})">
    ...
    <!--begin::Modal -  edit Spotlight-->
    <div class="modal fade" id="spotLightEditModal" tabindex="-1" aria-hidden="true"> </div>
                ...
                <div class="row">
                    ...
                    <form method="post" action="{{ route('add-premium') }}">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="hidden" name="category" class="form-control mb-2" value="Spotlight">
                            ...
                            <div class="modal-body py-lg-8 px-lg-7">
                                <div class="card-body pt-0 px-0 pb-0">
                                    <div class="mb-5 fv-row fv-plugins-icon-container">
                                        ...
                                        <div class="mb-5 fv-row fv-plugins-icon-container">
                                            <label class="required form-label">Sportlight Count</label>
                                            <input type="text" name="spot_light_count" class="form-control mb-2"
                                                placeholder="Enter Sportlight Count">
                                        </div>
                                        <div class="mb-5 fv-row fv-plugins-icon-container">
                            ...
                            <div class="modal-footer py-lg-8 px-lg-7">
                                <div class="d-flex justify-content-end">
                                    ...
                                    <button type="submit" id="kt_ecommerce_add_category_submit"
                                        class="btn btn-shadow btn-primary"> Add </button>
                                </div>
                            </div>
                        </div>
