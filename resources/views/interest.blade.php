...
@section('content')
    ...
    <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
            ...
            <div class="toolbar" id="kt_toolbar">
                <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                    <div class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                        <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Interest List</h1>
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                            ...
                            <li class="breadcrumb-item text-dark">Interest List</li>
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                    <div class="d-flex align-items-center py-1">
                        <a href="#" data-bs-toggle="modal" data-bs-target="#kt_modal_offer_a_deal"
                            class="btn btn-sm btn-shadow btn-primary">Add Interest</a>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="card-title">
                                        <div class="d-flex align-items-center position-relative my-1">
                                            ...
                                            <input type="text" data-kt-ecommerce-product-filter="search"
                                                ...
                                                placeholder="Search interest here" id="myInput" />
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0" id="example">
                                            <thead>
                                                <tr class="fs-7 fw-bolder text-gray-500">
                                                    ...
                                                    <th class="min-w-140px">Interest Category</th>
                                                    <th class="min-w-140px">Interest Description</th>
                                            ...
                                            <tbody>
                                                ...
                                                @if (!empty($interest))
                                                    @foreach ($interest as $key => $interestdetails)
                                                        <tr>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <span
                                                                        class="text-dark fs-7">{{ $interestdetails->title }}</span>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="d-flex justify-content-start flex-column">
                                                                    <span class="text-dark fs-7">
                                                                        @php $values = $interestdetails->sub_title; @endphp
                                                                        @if (!empty($values))
                                                                            <ul>
                                                            ...
                                                            <td class="text-end">
                                                                <div class="d-flex justify-content-end flex-shrink-0">
                                                                    ...
                                                                    <a href="#" onclick="ShowEditInterestForm({{$interestdetails->id}})"
        ...
        <div class="modal fade" id="kt_modal_offer_a_deal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered mw-400px">
                <div class="modal-content">
                    ...
                    <form method="post" action="{{ route('add-interest') }}">
                        @csrf
                            ...
                            <div class="card-body ps-0 pe-0 py-0 pt-0">
                                <div class="mb-5 fv-row fv-plugins-icon-container">
                                    ...
                                    <div class="mb-5 fv-row">
                                       <input type="text" name="title" class="form-control mb-2 option_counter" required placeholder="Enter title here..." />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="mb-5 fv-row fv-plugins-icon-container">
                                    ...
                                    <div class="mb-5 fv-row possesive_main">
                                        <div class="possesive_wrapper">
                                            <input type="text" name="possasive[]" required class="form-control mb-2 option_counter" placeholder="Enter interest here..." />
                                            <a href="javascript:void(0);" class="add_button add_remove_botton" title="Add field"><img src="assets/media/images/add-icon.png" /></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <!--end::Modal - add  interest -->

        <!--begin::Modal - edit  interest-->
        <div class="modal fade" id="editInterest" tabindex="-1" aria-hidden="true">
          
        </div>
        <!--end::Modal - edit interest-->
    @endsection
