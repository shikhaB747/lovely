...
@section('content')
    ...
    <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
            ...
            <div class="toolbar" id="kt_toolbar">
                <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                    <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                        ...
                        <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Membership</h1>
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                            ...
                            <li class="breadcrumb-item text-dark">Membership </li>
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                    <div class="d-flex align-items-center py-1">
                        <a href="#" class="btn btn-shadow btn-primary" data-bs-toggle="modal"
                            data-bs-target="#kt_modal_offer_a_deal">Add Membership</a>
                    </div>
                </div>
            </div>
                                        ...
                                        <table class="table table-row-dashed align-middle gs-0 gy-4 my-0" id="example">
                                            <thead>
                                                <tr class="fs-7 fw-bolder text-gray-500">
                                                    ...
                                                    <th class="min-w-150px">Total Day</th>
                                                ...
                                                @if (!empty($plansList))
                                                    @foreach ($plansList as $key => $plans)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <span class="text-muted">{{ $plans->validity }} days</span>
                                                            </td>
                                                            <td>
        ...
        <!--begin::Modal - edit membership-->
        <div class="modal fade" id="edit_membership_form" tabindex="-1" aria-hidden="true"> </div>
        <!--end::Modal   - edit membership-->

        <!--begin::Modal - add membership-->
        <div class="modal fade" id="kt_modal_offer_a_deal" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered mw-400px">
                <div class="modal-content ctgry-modl">
                    <form method="post" action="{{ route('add-premium') }}">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="card-body pt-0 px-0 pb-0">
                                        ...
                                        <div class="mb-5 fv-row fv-plugins-icon-container">
                                            ...
                                            <select class="form-select mb-2" data-control="select2"
                                                data-hide-search="true" name="validity" data-placeholder="Select Days"
                                                id="kt_ecommerce_add_category_store_template12">

                                                <option></option>
                                                <option value="7" duration="1 week"> 7 days (1 week) </option>
                                                <option value="30" duration="1 month"> 30 days (1 month) </option>
                                                <option value="90" duration="3 months"> 90 days (3 months) </option>
                                                <option value="180" duration="6 months"> 180 days (6 months) </option>
                                                <option value="365" duration="12 months"> 365 days (12 months)
                                                </option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="mb-5 fv-row fv-plugins-icon-container">
                                            ...
                                            <input type="text" name="duration" class="form-control mb-2"
                                                id="duration_in_text" readonly placeholder="Enter duration percent">
                                        </div>

                                        <input type="hidden" name="category" class="form-control mb-2" value="Premium">
                                        <input type="hidden" name="title" class="form-control mb-2"
                                            value="Get Premium">

                                        <div class="mb-5 fv-row fv-plugins-icon-container">
                                            <label class="form-label"> Duration </label>
                                            <input type="hidden" name="description" class="form-control mb-2"
                                                value="Unlimited extends,Unlimited rematch,Unlimited backtrack,Unlimited likes,5 Spotlights a week,5 Super Like a week,Fast track your likes,Stand out every day,See who\'s in Popular,Advanced filters,Incognito mode,Travel mode">
                                        </div>
